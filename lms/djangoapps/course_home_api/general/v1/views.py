"""
General view for the Course Home that contains information every page needs.
"""
...
from lms.djangoapps.course_home_api.general.v1.serializers import CourseHomeSerializer


class CourseHomeView(RetrieveAPIView):
    """
    **Use Cases**

        Request details for the Course Home MFE that every page needs.

    **Example Requests**

        GET api/course_home/v1/general/{course_key}
